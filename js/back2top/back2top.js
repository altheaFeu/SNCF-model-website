...
// Ajout du boutton
    if ($('#backToTopBtn').length == 0) {
        $('body').append('<button onclick="topFunction()" id="backToTopBtn" title="Vers le haut de la page"><ion-icon name="arrow-up-outline" class="arrow-up-outline"></ion-icon></button>');
    }
